...
namespace OceanToolkit
{
    ...
    public class OceanGrid : MonoBehaviour
    {
        ...
        public RelectionType reflectionType = RelectionType.Sky;
        ...
        [SerializeField]
        protected Vector4 waveScales = new Vector4(0.5f, 2.0f, 0.0f, 0.0f);
        [SerializeField]
        ...
        [SerializeField]
        protected float meshBoundsSize = 10000.0f;
        [SerializeField]
        ...
        [SerializeField]
        protected float specularRoughness = 0.0002f;
        [SerializeField]
        protected float specularIntensity = 1.0f;
        [SerializeField]
        protected float foamFalloff = 1.0f;
        [SerializeField]
        protected float relectionStrength = 0.9f;
        [SerializeField]
        protected float relectionNormalOffset = 0.1f;

        protected float foamStrength = 1.0f;

        public float FoamStrength
        {
            set { foamStrength = value; }
            get { return foamStrength; }
        }
        public float SpecularRoughness
        {
            get { return specularRoughness; }
        ...
        {
            set { foamFalloff = value; }
            get { return foamFalloff; }
        }
        public float RelectionStrength
        {
            set { relectionStrength = value; }
            get { return relectionStrength; }
        }
        public float RelectionNormalOffset
        {
            set { relectionNormalOffset = value; }
            get { return relectionNormalOffset; }
        }
        ...
        protected void CreateQuadMesh()
        {
            ...
            //underMeshFilter.sharedMesh = mesh;
        }
        ...
        protected void SendParamsToShader()
        {
            ...
            mat.SetColor("ot_DeepWaterColorUnlit", deepWaterColor);
            mat.SetFloat("_FoamFalloff", foamFalloff);
            mat.SetFloat("ot_FoamStrength",foamStrength);
            mat.SetFloat("ot_RefrNormalOffset", RelectionNormalOffset);

            switch (reflectionType)
            {
                case RelectionType.Off:
                    {
                        mat.EnableKeyword("OT_REFL_OFF");  
                        mat.DisableKeyword("OT_REFL_SKY_ONLY");  
                        mat.DisableKeyword("OT_REFL_SSR"); 
                    }
                    break;
                case RelectionType.Sky:
                    {
                        mat.DisableKeyword("OT_REFL_OFF");
                        mat.EnableKeyword("OT_REFL_SKY_ONLY");
                        mat.DisableKeyword("OT_REFL_SSR");
                    }
                    break;
                case RelectionType.SkyAndObject:
                    {
                        mat.DisableKeyword("OT_REFL_OFF");
                        mat.DisableKeyword("OT_REFL_SKY_ONLY");
                        mat.EnableKeyword("OT_REFL_SSR");
                    }
                    break;
                default:
                    break;
